    ...
    <main class="main_blog">
        <div class="container-fluid gedf-wrapper">
                        ...
                        <div class="card gedf-card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="ml-2">
                                        <input type="hidden" name="id_post" value="<?php  $_SESSION['id_post']= 1; ?>" />
                            ...
                            <div class="card-footer">
                                <a href="requests/scriptLikes.php?id_p=<?php echo $_SESSION['id_post']= 1; ?>&id_u=<?php echo $_SESSION['id_user']; ?>" class="card-link"><i class="fa fa-gittip"></i> Like</a>
                                <a  onclick="cacherComment()" class="card-link"><i class="fa fa-comment"></i> Comment</a>
                            </div>
                            <div id="monCommentaire">
                            <?php
            ...
            <div class="card gedf-card">
                ...
                <div class="card-footer">
                    <a href="requests/scriptLikes.php?id_p=<?php echo $_SESSION['id_post']= 2; ?>&id_u=<?php echo $_SESSION['id_user']; ?>" class="card-link"><i class="fa fa-gittip"></i> Like</a>
                    <a href="#" class="card-link"><i class="fa fa-comment"></i> Comment</a>
                </div>
                <div id="monCommentaire">
                            <?php
